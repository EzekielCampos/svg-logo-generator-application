...
describe("Shapes", () =>{
    ...
    describe("Circle", () =>{
        it("should return element tags for a circle", ()=>{
            ...
            expect(circleTest.render()).toBe(`<circle cx="150" cy="100" r="95" fill="Blue" stroke="black" stroke-width="2"/>`);
        });
    ...
    describe("Square", () =>{
        ...
        it("should return a string containing element tags for a square", () =>{
            ...
            expect(testSquare.render()).toBe(`<rect x="50" y="0" width="200" height="200" fill="Gold" stroke="black" stroke-width="2"/>`);
